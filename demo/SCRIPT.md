...
- [ ] <https://hvaler.github.io/cursus/> open in the **in-app browser**, hard-reloaded, plan
      **empty**, status line green: *WebMCP available — 11 tools registered.*
...
> "Eleven tools, registered with `document dot modelContext dot registerTool`. The thing that shaped
...
Eleven tools registered with document.modelContext.registerTool. Every tool call is an event and
